    ...
    componentDidMount() {
        ...
        window.addEventListener("scroll", () => {
            ...
            this.scrollTargetIds.map((sectionID, index) => {
                // eviter le refresh de la navbar quand il nya pas de section (cas de DemoSection)
                if (document.getElementById(sectionID) == null || document.querySelector("div[data-nav='list']") == null ){
                    return
                }
